    ...
    function printNextCharacter() {
        if(lineIndex < lines.length) {
            ...
            reloadButton.onclick = function() {
                window.location.href = 'flag01/first/flag01.html';
            };
...
let lines = [
    'Je me souviens qu\'à l\'époque, il utilisait beaucoup les commentaires dans son code, ça l\'aidait à se rappeler de ce qu\'il avait fait.',
    'Peut-être que cela pourrait nous aider.',
    '',
    'A toi de jouer ...',
...
function startTimer() {
    ...
    alert("Tu pensais vraiment que tu pourrais trouver la clé en 4 minutes ?! Tu es fou !\n\nTu as 4 minutes pour trouver la clé, sinon tu devras recharger la page. Bonne chance !");
    ...
    // Utiliser la fonction pour stocker le message dans un cookie
    storeInCookie("pass", hiddenMessage, "/");
}
